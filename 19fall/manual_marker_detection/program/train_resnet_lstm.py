...
def main():
    ...
    train_data =  EyeBrowDataset('/dresden/users/rx43/ASL/eyebrow_detecting/dataset/train_all.mat', '/dresden/users/rx43/ASL/eyebrow_detecting/',
                       args.window_size,
                       transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
                       ]))
    val_data = EyeBrowDataset('/dresden/users/rx43/ASL/eyebrow_detecting/dataset/validation_all.mat',
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if val_loss < min_val_loss:
                ...
                torch.save(D_xs.state_dict(),
                           '{}/epoch_{}_val_loss_{}.pth'.format(args.outf, epoch + e_shift, val_loss))
