...
#train
	...
	for epoch in range(args.epochs):
		...
		print("Trainning accuracy for epoch:[%2d]: %.4f" %(epoch, train_accuracy))
		info2 = {'train_accuracy':train_accuracy}
		for tag, value in info.items():
		...
		with torch.no_grad():
			...
			print("Validating accuracy for epoch:[%2d]: %.4f" %(epoch, train_accuracy))
			info = { 'vali_loss': mse_sum, 'vali_accuracy': vali_accuracy}
