...
parser.add_argument("-b", "--batch_size", type=int, default=4) # 16
...
parser.add_argument('-w', '--window_size', default=3, type=int,
...
def main():
	...
	log_path = 'log/lr_{}'.format(args.learning_rate)
	# try:
	# 	os.mkdir(log_path)
	# except:
	# 	pass
	...
	mes_sum=0
	i, (data, value) =next(enumerate(train_loader))
	...
	for epoch in range(args.epochs):
		...
		#i%1 == 0:
			...
			writer.add_scalar('train/loss',mes_sum,epoch)
